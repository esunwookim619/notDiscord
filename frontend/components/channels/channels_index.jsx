  ...
  render() {
    ...
    return (
      <div className="channelsindex">
        ...
        <div>
          <div className="textchannels"><span className="chevron">⌄</span> <span className="textchannelstext">TEXT CHANNELS</span> <span className="plus" onClick={() => this.props.openModal('create channel')}>+</span></div>
        </div>
