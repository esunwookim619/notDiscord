        ...
        <div>
          <div className="channelsindex">
            ...
            <div className="defaultusernamebar">
              ...
              <svg 
                onMouseEnter={() => this.setState({ isHovering2: true })}
                onMouseLeave={() => this.setState({ isHovering2: false })}
                ...
                {this.state.isHovering2 && <div className="hovering-edit-user"><p className="hovering-edit-user-text">Edit User</p></div>}
            </div>
