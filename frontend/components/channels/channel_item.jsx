  ...
  render() {
    ...
    return (
      <button
        ...
        onClick={() => this.props.props.history.push(`/channels/${this.props.props.currentServerId}/${this.props.channel.id}`)}
        className="channelitem" key={this.props.channel.id}><div className="channame">
          ...
          <div className="channametext">{this.props.channel.channel_name}</div>
        </div>
          ...
          <div className="channeliconcontainer">
            ...
            <img className="deletetrashcan" src={window.delete} onClick={() => {
              ...
              if (this.props.channels.length > 1) {
                this.MouseHover();
                this.props.props.deleteChannel(this.props.channel.id).then(() => {
                  this.props.props.history.push(`/channels/${this.props.props.currentServerId}/${this.props.first.id}`)
                })
              }
            }} />
          </div>}
